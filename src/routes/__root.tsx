...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "getWorkers connects verified migrant workers with trusted Singapore companies. Transparent, reliable, efficient hiring." },
      { property: "og:title", content: "getWorkers — Transparent hiring in Singapore" },
      { property: "og:description", content: "Connect verified workers with trusted Singapore companies. Transparent hiring with no hidden fees." },
