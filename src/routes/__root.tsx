...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "getWorkers connects migrant workers directly to Singapore businesses. No agent fees, ever." },
      { property: "og:title", content: "getWorkers — Direct hiring in Singapore" },
      { property: "og:description", content: "Connect workers and Singapore businesses directly. Zero placement fees." },
